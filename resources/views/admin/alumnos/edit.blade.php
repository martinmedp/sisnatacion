        ...
        <div class="card-body">
            ...
            @if ($alumno->user_id)
                ...
                <small class="text-muted d-block mt-1">
                    Genera una nueva contraseña temporal para la cuenta de acceso de este alumno.
                </small>

                <form id="form-restablecer-clave" action="{{ route('admin.alumnos.restablecerClave', $alumno->id) }}" method="POST" style="display:none;">
                    @csrf
                    @method('PUT')
                </form>
            @else
                ...
                <p class="text-muted mb-0">
                    <i class="fas fa-info-circle"></i> Este alumno no tiene cuenta de acceso (sin correo registrado).
                </p>
            @endif
        </div>
    </div>
